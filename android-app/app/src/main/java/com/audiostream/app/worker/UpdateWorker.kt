...
package com.audiostream.app.worker
...
import com.audiostream.app.ui.MainActivity
import com.audiostream.app.R
import com.audiostream.app.model.Channel
import com.audiostream.app.model.LatestRelease
import com.audiostream.app.model.Notification
import com.audiostream.app.model.Util
...
class UpdateWorker(appContext: Context, workerParams: WorkerParameters) : Worker(appContext, workerParams) {
    ...
    override fun doWork(): Result {
        ...
        MainScope().launch(Dispatchers.IO) {
            ...
            val res =
                httpClient.get("https://api.github.com/repos/audiostream/audiostream/releases/latest")
            ...
            withContext(Dispatchers.Main) {
                ...
                val apkAsset = latestRelease.assets.find {
                    it.name.matches(Regex("AudioStream-[0-9.]*-release.apk"))
                }
                if (apkAsset == null) {
