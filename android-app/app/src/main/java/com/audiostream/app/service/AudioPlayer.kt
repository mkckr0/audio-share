...
import com.audiostream.app.pb.AudioEncoding
...
import com.audiostream.app.model.AudioConfigKeys
import com.audiostream.app.model.NetworkConfigKeys
import com.audiostream.app.model.audioConfigDataStore
import com.audiostream.app.model.getFloat
import com.audiostream.app.model.getInteger
import com.audiostream.app.model.getResourceUri
import com.audiostream.app.model.networkConfigDataStore
...
//            Log.d(tag, "logMessage: $message")
        ...
        override suspend fun onReceiveAudioFormat(format: PbAudioFormat) {
            val encoding = when (format.encoding) {
                AudioEncoding.ENCODING_PCM_FLOAT -> AudioFormat.ENCODING_PCM_FLOAT
                AudioEncoding.ENCODING_PCM_8BIT -> AudioFormat.ENCODING_PCM_8BIT
                AudioEncoding.ENCODING_PCM_16BIT -> AudioFormat.ENCODING_PCM_16BIT
                AudioEncoding.ENCODING_PCM_24BIT_PACKED -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
                    AudioFormat.ENCODING_PCM_24BIT_PACKED
                } else {
                    AudioFormat.ENCODING_INVALID
                }

                AudioEncoding.ENCODING_PCM_32BIT -> if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.S) {
