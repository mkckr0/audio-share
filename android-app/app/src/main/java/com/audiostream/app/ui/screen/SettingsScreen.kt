...
package com.audiostream.app.ui.screen
...
import com.audiostream.app.BuildConfig
import com.audiostream.app.R
import com.audiostream.app.model.AppSettingsKeys
import com.audiostream.app.model.WorkName
import com.audiostream.app.model.getBoolean
import com.audiostream.app.ui.base.EditTextPreference
import com.audiostream.app.ui.base.Preference
import com.audiostream.app.ui.base.PreferenceCategory
import com.audiostream.app.ui.base.PreferenceScreen
import com.audiostream.app.ui.base.SwitchPreference
import com.audiostream.app.ui.base.rememberIntent
import com.audiostream.app.ui.theme.AppTheme
import com.audiostream.app.ui.theme.isDynamicColorFromWallpaperAvailable
import com.audiostream.app.ui.theme.parseColor
import com.audiostream.app.worker.UpdateWorker
...
//                            PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS, TimeUnit.MILLISECONDS,
        ...
        PreferenceCategory(context.getString(R.string.label_about)) {
            ...
            Preference(
                ...
                intent = rememberIntent(
                    Intent.ACTION_VIEW,
                    "https://github.com/audiostream/audiostream/releases/tag/v${BuildConfig.VERSION_NAME}"
                ),
            )
        }
    }
