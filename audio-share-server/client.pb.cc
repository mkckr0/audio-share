...
const uint32_t TableStruct_client_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::AudioFormat, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
...
AudioFormat::AudioFormat(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  // @@protoc_insertion_point(arena_constructor:AudioFormat)
}
AudioFormat::AudioFormat(const AudioFormat& from)
  ...
  ::memcpy(&_impl_.format_tag_, &from._impl_.format_tag_,
    ...
    reinterpret_cast<char*>(&_impl_.format_tag_)) + sizeof(_impl_.sample_rate_));
  // @@protoc_insertion_point(copy_constructor:AudioFormat)
}
...
AudioFormat::~AudioFormat() {
  // @@protoc_insertion_point(destructor:AudioFormat)
...
// @@protoc_insertion_point(message_clear_start:AudioFormat)
...
uint8_t* AudioFormat::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:AudioFormat)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (this->_internal_bits_per_sample() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteInt32ToArray(2, this->_internal_bits_per_sample(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:AudioFormat)
  return target;
}

size_t AudioFormat::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:AudioFormat)
  size_t total_size = 0;
...
void AudioFormat::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:AudioFormat)
...
// @@protoc_insertion_point(class_specific_copy_from_start:AudioFormat)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::AudioFormat*
Arena::CreateMaybeMessage< ::AudioFormat >(Arena* arena) {
  return Arena::CreateMessageInternal< ::AudioFormat >(arena);
}
